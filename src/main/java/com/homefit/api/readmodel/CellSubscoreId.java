...
public class CellSubscoreId implements Serializable {
    ...
    public CellSubscoreId(Long cellH3, String dimension) { this.cellH3 = cellH3; this.dimension = dimension; }
    ...
    @Override public int hashCode() { return Objects.hash(cellH3, dimension); }
}
